      ...
      <div class="container mt-5">
        <div class="row block-9">
	            ...
	            <div class="col-md-12 mb-3">
	              <p><span>Address :</span> Ds. Segeran Blok Alimunjaya RT 14/RW 07 Kec.Juntinyuat Kab.Indramayu Prov.Jabar</p>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p><span>Phone :</span> <a href="tel://1234567920"> 082-322-474-229</a></p>
	            </div>
						</div>
					</div>
					<div class="col-md-12 mb-4">
            ...
            <form action="contact.php" method="post" class="appointment-form">
              ...
              <div class="d-md-flex">                
                <div class="form-group ml-md-12">
                  <input type="text" class="form-control" name="telpon" placeholder="Phone">
                </div>
              </div>
              <h7>*Sertakan tanggal pengambilan pesanan dikolom bawah ini
              <div class="form-group ml-md-12">
                <div class="form-group">
                  <h4>CATATAN</h4>
                  <textarea name="message" id="mytextarea" cols="30" rows="2" class="form-control" placeholder="Message"></textarea>
                </div>
                <div class="form-group ml-md-12">
                  <input type="submit" name="Go" value="PESAN" class="btn btn-dark py-3 px-4">
                </div>
          ...
          <div class="col-lg-12 text">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Ds. Segeran Blok Alimunjaya RT 14/RW 07 Kec.Juntinyuat, Kab.Indramayu, Prov.Jabar</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">082322474229</span></a></li>
                </ul>
              </div>
            </div>
          </div>
